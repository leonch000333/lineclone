...
export const VoteDetailDrawer = memo((props) => {
  ...
  const onChangeSelector1 = (e) => setSelector1(e.target.value);
  const onChangeSelector2 = (e) => setSelector2(e.target.value);
  const onChangeSelector3 = (e) => setSelector3(e.target.value);
  const onChangeSelector4 = (e) => setSelector4(e.target.value);
  ...
  return (
    <>
      ...
      >
        <DrawerOverlay />
        <DrawerContent>
          <DrawerHeaders onClick={onCloseVoteDetailDrawer} children="投票を作成" />
            ...
            <Stack spacing={4}>
              ...
              {check1 === true ? (
                <Flex flexDirection="row">
                  <Box ref={(ref) => ref?.appendChild(setYear())}></Box>
                  <Box ref={(ref) => ref?.appendChild(setMonth())}></Box>
                  <Box ref={(ref) => ref?.appendChild(setDay())}></Box>
                </Flex>
              ) : null}
